...
def main():
    ...
    for num_samples in num_samples_options:
        folderpath = "./results/datasets/engineering_new/"
        folderfull = "./results/datasets/engineeringfull/"
        problems = {
            "kursawe": kursawe,
            "four_bar": four_bar_plane_truss,
            "gear_train": gear_train_design,
            "pressure": pressure_vessel,
            "speed_reducer": speed_reducer,
            "welded_beam": welded_beam_design,
        ...
        for problem in problems:
            ...
            datafull.to_csv(
                folderfull + problem + "_" + str(num_samples) + ".csv", index=False
            )
